...
add('Drug Reference removes redundant helper copy and persistent catalog count',!demo.includes('Search 100 concise pharmacist monographs')&&!demo.includes('Concise educational reference. Verify the current label')&&demo.includes('id="drugRefCount"></span>'));
add('Study Cards action sits inside the selected medication header',demo.includes("drugMonoHTML(m.key,true,action)")&&demo.includes("drug-ref-mono-head")&&demo.includes("Saved to Study Cards"));
