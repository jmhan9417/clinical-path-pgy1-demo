...
add('Drug names use a distinct marker highlight and medication tooltip', demo.includes('function enhanceDrugTerms(root)') && demo.includes('.drug-term{') && demo.includes('.drug-tip{') && demo.includes('FDA label is listed in References'));
